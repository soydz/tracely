            ...
            {isAuthenticated
                    ...
                    <div className="flex items-center justify-between gap-6">
                        <nav className="flex items-center gap-1">
                            <Tabs variant="secondary" className="w-full max-w-md" selectedKey={currenTab} onSelectionChange={(key) => {
                                ...
                                <Tabs.ListContainer>
                                    <Tabs.List aria-label="Options" className="flex border-none py-4">
                                        <Tabs.Tab id="Home" className="flex flex-row gap-1 text-base font-medium">
                                        ...
                                        <Tabs.Tab id="Budgets" className="text-base font-medium">
                                            Budgets
                                            <Tabs.Indicator />
                                        </Tabs.Tab>
                                        <Tabs.Tab id="Logs" className="text-base font-medium">
                                            Logs
                                            <Tabs.Indicator />
                                        </Tabs.Tab>
                                    </Tabs.List>
                ...
                <div className="flex items-center justify-between gap-6">
                    ...
                    <div className="flex flex-row gap-3">
                        ...
                        <Link href="/register" className="flex items-center gap-2 py-2 px-8 text-foreground hover:opacity-90 " >
                            Sign up
                        </Link>
                        <Link href="/login" className="flex items-center gap-2 py-2 px-8 bg-accent text-foreground hover:opacity-90 transition-all rounded-full" >
                            Log in
                        </Link>
                    </div>
                </div>
